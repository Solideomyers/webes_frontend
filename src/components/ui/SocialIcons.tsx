...
export const SocialIcons: React.FC<Props> = ({ proname, description }) => {
  return (
    <>
      <span className='flex items-center py-2 border-gray-200 space-x-2s'>
        {/* share button */}
        <ShareButton proname={proname} description={description} />
        {/* facebook */}
        <Link
